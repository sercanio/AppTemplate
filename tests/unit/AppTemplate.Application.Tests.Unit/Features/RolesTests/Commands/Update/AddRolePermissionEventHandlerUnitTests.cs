...
[Trait("Category", "Unit")]
public class AddRolePermissionEventHandlerUnitTests
{
  private readonly Mock<ILogger<AddRolePermissionEventHandler>> _loggerMock;
  private readonly AddRolePermissionEventHandler _handler;

  public AddRolePermissionEventHandlerUnitTests()
  {
    _loggerMock = new Mock<ILogger<AddRolePermissionEventHandler>>();
    _handler = new AddRolePermissionEventHandler(_loggerMock.Object);
  }
  ...
  public async Task Handle_ShouldLogInformation_WhenEventIsHandled()
  {
    ...
    var domainEvent = new RolePermissionAddedDomainEvent(roleId, permissionId);
    ...
    _loggerMock.Verify(
        x => x.Log(
            ...
            It.Is<It.IsAnyType>((v, t) =>
                v.ToString()!.Contains("Handling RolePermissionAddedDomainEvent") &&
  ...
  {
    // Arrange
    var event1 = new RolePermissionAddedDomainEvent(Guid.NewGuid(), Guid.NewGuid());
    var event2 = new RolePermissionAddedDomainEvent(Guid.NewGuid(), Guid.NewGuid());
    var cancellationToken = CancellationToken.None;
    ...
    _loggerMock.Verify(
        x => x.Log(
            LogLevel.Information,
            It.IsAny<EventId>(),
            It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Handling RolePermissionAddedDomainEvent")),
            It.IsAny<Exception>(),
            It.Is<Func<It.IsAnyType, Exception?, string>>((v, t) => true)),
        Times.Exactly(2));
  }
  ...
  {
    // Arrange & Act
    var handler = new AddRolePermissionEventHandler(_loggerMock.Object);
